                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          style: TextButton.styleFrom(
                            foregroundColor: OperatorTheme.mutedText,
                          ),
...
class _InfoCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final iconColor = accent ?? OperatorTheme.accent;
    return Container(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: OperatorTheme.hairline),
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide(color: OperatorTheme.accent, width: 2),
        ),
        suffixIcon: Padding(
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(color: OperatorTheme.mutedText),
        filled: true,
        fillColor: OperatorTheme.surface,
...
class _ErrorBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: OperatorTheme.danger.withValues(alpha: 0.10),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: OperatorTheme.danger.withValues(alpha: 0.4),
        ),
      ),
      child: Row(
        children: [
          Icon(Icons.error_outline_rounded,
              color: OperatorTheme.danger, size: 18),
        ...
        child: InkWell(
          ...
          child: Ink(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(18),
              boxShadow: onTap == null ? null : OperatorTheme.softShadow,
            ),
            child: Padding(
