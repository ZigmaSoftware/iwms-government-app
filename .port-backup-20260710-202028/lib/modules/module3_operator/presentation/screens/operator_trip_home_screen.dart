...
import 'package:iwms_citizen_app/modules/module2_driver/presentation/widgets/captain_feedback.dart';
...
class OperatorTripHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SafeArea(child: OperatorTripBody(showScanFab: true)),
    );
  }
}
  ...
  if (errorText != null) {
    messenger?.showSnackBar(
      SnackBar(
        ...
        backgroundColor: OperatorTheme.danger,
      ),
    );
    return;
  }
          ...
          children: [
            ...
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                foregroundColor: OperatorTheme.primary,
                side: BorderSide(color: OperatorTheme.hairline),
                padding:
