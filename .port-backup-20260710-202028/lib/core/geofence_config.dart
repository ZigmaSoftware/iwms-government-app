...
class GammaGeofenceConfig {
  ...
  /// Lowercase hint used to identify the configured facility address.
  static const String addressHint = 'integrated waste management facility';
