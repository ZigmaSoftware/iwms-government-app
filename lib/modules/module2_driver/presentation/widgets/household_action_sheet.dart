...
Future<bool> showHouseholdActionSheet(
  ...
  // One drawer: customer identity at the top, the colour-coded waste grid in
  // the middle, and the two exception options at the bottom. There is no
  // separate "Confirm customer" step any more — the driver scans and is
  ...
  final collected = await showModalBottomSheet<bool>(
    ...
    // The keyboard opens over this for weight entry and the grid grows as a
