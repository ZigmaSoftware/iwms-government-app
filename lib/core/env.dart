...
///   flutter run --dart-define=VITE_PROD=true --dart-define=VITE_ENFORCE_PERMISSIONS=false --dart-define=VITE_GOVERNMENT_API_LOCAL=http://192.168.1.128:9001/api/v1
...
const String _defaultGovernmentApiBase = 'http://192.168.1.128:9001/api/v1';
const String _defaultGovernmentBackendOrigin = 'http://192.168.1.128:9001';
